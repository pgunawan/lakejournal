...
<table border="0" cellpadding="0" cellspacing="0" class="centeringtable">
  <tr>
    <td align="center" valign="top"><table width="919" border="0" cellpadding="0" cellspacing="0" background="images/background.png">
      <tr>
      ...
      <tr>
        <td class="contentcell" id="soundingssubmenu"><!-- InstanceBeginEditable name="announcements" -->
          <div id="toplineannouncement">If you prefer to mail the subscription form and your payment, you may <a href="Subscription_form.doc">download the subscription form here(MS Word)</a></div>
        <!-- InstanceEndEditable --></td>
      </tr>
      <tr>
        <td class="soundings" id="soundingscontent"><!-- InstanceBeginEditable name="soundingsleftcolumn" -->
          <div id="leftcolumn">
            <p class="articletitle">Purchase a single issue:</p>
            <p>Price of a single back issue is $14.95+GST. This includes shipping in Canada. For international shipping, please <a href="contact.php">contact us. </a></p>
            <form action="sendmail.php" method="post" name="mainForm" id="mainForm">
            	<input type="hidden" name="subject" value="LAKE - Back issues" />
				<input type="hidden" name="redirect" value="https://www.paypal.com/cgi-bin/webscr" />
				<input type="hidden" name="return" value="thank_you_back_issues.php">
				<input type="text" name="automatic_access" id="automatic_access" class="automatic_access"/>
	            <input name="require" type="hidden" id="require" value="" />
	            <table width="400" border="0" cellspacing="0" cellpadding="5">
                <tr>
                  <td colspan="2"><label></label></td>
                  </tr>
                <tr>
                  <td>Send me an issue of </td>
                  <td><p>
                    <input name="issue" type="checkbox" id="issue" value="Issue #1" />
Issue #1<br />
<input name="issue2" type="checkbox" id="checkbox4" value="Issue #2" />
Issue #2 (Sold Out)</p>
                    <p>
                      <input name="issue3" type="checkbox" id="issue3" value="Issue #3" />
                      Issue #3</p>
                    <p>
                      <input name="issue4" type="checkbox" id="issue4" value="Issue #4" />
                    Issue #4</
                <tr class="alternaterow">
                </p>
                    <p>
                      <input name="issue5" type="checkbox" id="issue5" value="Issue #5" />
                    Issue #5</tr>
                <tr class="alternaterow"> 
                ...
                <tr>
                  <td class="alternaterow">Country</td>
                  <td class="alternaterow"><!-- start of drop down country selection list -->
...
<!-- end of drop down country selection list -->                  </td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td><br />
                  <input type="submit" name="button" id="button" value="Proceed To Payment Page" /></td>
                </tr>
              </table>
              </form>
            <p>You may also want to check out  <a href="list_of_bookstores.php">the list of  independent bookstores where LAKE is distributed </a></p>
            <p><br />
                <strong><a href="http://www.ecoartspace.org/"></a></strong></p>
          </div>
          <!-- InstanceEndEditable --><!-- InstanceBeginEditable name="soundingsrightcolumn" -->
          <div id="rightcolumn"><img src="images/illustrations/fall_08_secondary_ill_01.jpg" width="260" height="180" class="extraillustration" />
              <div class="extraillustrationcaption">
                <p>Ernie Kroegger, Glacier Crest, 2001, detail<br />
                  Chromogenic print, 66cm x 66cm</p>
              </div>
          </div>
          <!-- InstanceEndEditable --></td>
      </tr>
