...
$recipient = "lake.journal@ubc.ca";
//$recipient = "lake.journal@ubc.ca"; // youremail@domain.com



// bcc emails (separate multiples with commas (,))

$bcc = "natalia@idea-bureau.com";
//$bcc = "natalia@idea-bureau.com";

$paypay_email = "lake.journal@ubc.ca";

// this is the email address that the email will appear to come from
$email = "lake.journal@ubc.ca";

// referers.. domains/ips that you will allow forms to

// reside on.

$referers = array ('clients.idea-bureau.com','lakejournal.ca','121.0.0.111');
...
//For older versions of PHP we need to assign values to POST variables
...
function parse_form($array, $sort = "") {
   ...
   $reserved_keys[] = "automatic_access";
...
if ($require) {
   ...
   if($automatic_access) {
		$missing_field_list .= "<b>Missing: automatic_access</b><br>\n";
   }
...
if ($redirect) {
   ...
   Thank you - you are being redirected to PayPal for payment processing.

   <form name=\"myForm\" method=\"post\" action=\"https://www.paypal.com/cgi-bin/webscr\" target=\"_self\">
	<input type=\"hidden\" name=\"currency_code\" value=\"CAD\">
	<input type=\"hidden\" name=\"lc\" value=\"CA\" />
   <input type=\"hidden\" name=\"business\" value=\"$paypay_email\">
