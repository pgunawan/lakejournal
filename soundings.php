    ...
    <?php include("header.html");?>
      ...
      <tr>
        <td class="contentcell" id="soundingssubmenu"><!-- InstanceBeginEditable name="issuename" -->
          <ul>
            <li><u>Reviews</u></li>
             <li><a href="soundings_resources.php">Resources</a></li>
             <li><a href="soundings_poems.php">Poems</a></li>
            </ul>
